def seed_extra_data(db, Hospital, Doctor, Pharmacy):
    ...
    pharmacies = [
        ...
        Pharmacy(name="Sadana Medical Store", address="310/2-A NO. 3, opposite AIIMS GATE, Saket Nagar, Bhopal, Madhya Pradesh 462024", city="Bhopal", phone="9152232483", open_24hrs=True,area
                 ="Saket Nagar"),
        Pharmacy(name="Moolchand Medical Stores", address="Shop No: 3 Plot, No: 2, New Market Main Rd, New Market, STT Nagar, TT Nagar, Bhopal, Madhya Pradesh 462003", city="Bhopal", phone="755-4223752", open_24hrs=True ,area="New Market"),
        Pharmacy(name="Apollo Pharmacy", address="Shop No.1, Ground Floor, near Madhuram Palace Hotel, C Sector, Nehru Nagar, Bhopal, Madhya Pradesh 462003", city="Bhopal", phone="0755-4308101", open_24hrs=True,area="Nehru Nagar"),
        Pharmacy(name="Verma Medical Store", address="Shop No 3, Near, Opposite Santoshi Mata Mandir Square, Naveen Nagar, Bhopal-462010, Madhya Pradesh", city="Bhopal", phone="9098506916", open_24hrs=False,area="Naveen Nagar"),
        Pharmacy(name="Palak Medical Store", address=" Madan Market, 8, opp. Govt. Primary Health Center, Madan Market, Misrod, Bhopal, Madhya Pradesh 462047", city="Bhopal", phone="9827017797", open_24hrs=True,area="Madan Market"),
        Pharmacy(name="Yadav Chemist", address="6C3W+6C9, Narmadapuram Rd, Narayan Market, Near State Bank ATM, Narayan Nagar, Bhopal, Madhya Pradesh 462026", city="Bhopal", phone="755-4223752", open_24hrs=False,area="Narayan Nagar"),
        Pharmacy(name="Guru Medical Stores", address="Shop G 13, Gulmohar, Door Sanchar Colony, Shahpura, Bhopal, Madhya Pradesh 462039", city="Bhopal", phone="9713198600", open_24hrs=True,area="Shahpura"),
        Pharmacy(name="Shree Balaji Medical", address=" 04, Nerala Road, Chatrapati Nagar, Near Naman Sweet and Indian Petrol Pump, Ayodhya Nagar, Bhopal-462041, Madhya Pradesh", city="Bhopal", phone="9893406569", open_24hrs=False,area="Ayodhya Nagar"),
        Pharmacy(name="Khandelwal Medical", address="Main market, durga chowk, Vidya Nagar, Mandideep, Bhopal, Madhya Pradesh 462046", city="Bhopal", phone="9425023836", open_24hrs=False,area="Mandideep"),
        Pharmacy(name="Chaturvedi Medical", address="8, Plot No 49-51, Panjab National Bank, Main Street, Trilanga, Bhopal-462039, Madhya Pradesh", city="Bhopal", phone="9039338512", open_24hrs=False,area="Trilanga"),
        Pharmacy(name="Dameera Pharmacy", address="18, Bansal Vihar Colony, Rohit Nagar, Bawadiya Kalan, Gulmohar Colony, Bhopal, Madhya Pradesh 462039", city="Bhopal", phone="9926551307", open_24hrs=True,area="Gulmohar Colony"),
        Pharmacy(name="Shiva Medical", address="10, Near 12 No Bus Stop, Main Road, Arera Colony, Bhopal-462016, Madhya Pradesh", city="Bhopal", phone="9131794847", open_24hrs=True,area="Arera Colony"),
        Pharmacy(name="B K Gupta Medical", address="Shop No 47, Near JP Hospital, 1250, Bhopal, Madhya Pradesh 462003", city="Bhopal", phone="755-2970008", open_24hrs=False,area="Bhopal"),
        Pharmacy(name="We Care Pharma", address="Shop No - G 40, Surendra Manik Complex, Awadhpuri, Bhopal, Madhya Pradesh 462022", city="Bhopal", phone="9827668531", open_24hrs=True,
                 area="Awadhpuri"),
        Pharmacy(name="H R Pharmacy", address="2, 11 Mill, Near By Parmar Aata Chakki, In Front Of Wine Shop, Misord, Bhopal-462047, Madhya Pradesh", city="Bhopal", phone="9425020293", open_24hrs=False,area="Misrod"),
        Pharmacy(name="Siddhant Medical Store", address="KotraltaKalKheda, Opposite Mathura Dairy, Kotra Sultanabad, Kamla Nagar, Bhopal-462003, Madhya Pradeshnabad", city="Bhopal", phone="9893129418", open_24hrs=False,area="Kamla Nagar"),

        # 30+ More Bhopal Pharmacies
        Pharmacy(name="Sanjeevani Medical", address="Zone I, M P Nagar, Bhopal-462011, Madhya Pradesh", city="Bhopal", phone="9111222333", open_24hrs=True,area="M P Nagar"),
        Pharmacy(name="Relief Medicos", address="9, Jain Tower, Police Line, Nehru Nagar, Bhopal - 462003", city="Bhopal", phone="9111222334", open_24hrs=False,area="Nehru Nagar"),
        Pharmacy(name="Apex Pharmacy", address="Apex Hospital Building No. 116, 117, Sindhi Colony Square, Berasia Road, Bhopal-462001, Madhya Pradesh", city="Bhopal", phone="9111222335", open_24hrs=True,area="Bhopal"),
        Pharmacy(name="HealthPlus Pharmacy", address="A-15, Mandakini Colony, Tathastu Dental Clinic, Kolar Road, Bhopal-462042, Madhya Pradesh", city="Bhopal", phone="9111222336", open_24hrs=True,area="Kolar Road"),
        Pharmacy(name="Narmada Medical Store", address="E3/23 Arora Colony, Arera Colony, Bhopal-462016, Madhya Pradesh", city="Bhopal", phone="9111222337", open_24hrs=False,area="Arera Colony"),
        Pharmacy(name="JK Medical", address="Sector C, Near Bhima Kunj, Sarvadharam, Kolar Road, Bhopal-462042, Madhya Pradesh", city="Bhopal", phone="9111222338", open_24hrs=True,area="Kolar Road"),
        Pharmacy(name="Peoples Medical", address="04, Karond Bypass Rd, Peoples Campus, Bhanpur, Bhopal, Madhya Pradesh 462037", city="Bhopal", phone="9111222339", open_24hrs=True,area="Bhanpur"),
        Pharmacy(name="Navjeevan Medicos", address="652, Katara Hills Rd, Arvind Vihar, Bagmugaliya, Bhopal, Madhya Pradesh 462043", city="Bhopal", phone="9111222340", open_24hrs=False,area="Bagmugaliya"),
        Pharmacy(name="Care Pharmacy", address="Avinash Nagar, Adharshila East Block Extension, Bhopal-462022, Madhya Pradesh", city="Bhopal", phone="9111222341", open_24hrs=True,area="Bhopal"),
        Pharmacy(name="Wellness Store", address="Bus Stop, near No.10, E-7, Shahpura, Bhopal, Madhya Pradesh 462016 ", city="Bhopal", phone="9111222342", open_24hrs=False,area="Shahpura"),
        Pharmacy(name="Shri Ram Medical", address="No.18, Near Minal Residency Bhl Gate No 1, A Bhagat Singh Market, Indrapuri, Bhopal-462023, Madhya Pradesh", city="Bhopal", phone="9111222343", open_24hrs=True,area="Indrapuri"),
        Pharmacy(name="City Care Medical Store", address="77 in front of, 80, Taj-ul-Masjid Rd, Motia Talab, Kali Basti, Bhopal, Madhya Pradesh 462001", city="Bhopal", phone="9111222344", open_24hrs=False,area="Kali Basti"),
        Pharmacy(name="LifeLine Pharmacy", address=" A/498, B66, near Manisha Market, Varun Nagar, Sector B, Shahpura, Bhopal, Madhya Pradesh 462039", city="Bhopal", phone="9111222345", open_24hrs=True,area="Shahpura"),
        Pharmacy(name="Hope Medicos", address="Nirmal Complex, Near Pratima Marriage Garden, Azad Nagar, Ayodhya Nagar, Bhopal-462041, Madhya Pradesh", city="Bhopal", phone="9111222346", open_24hrs=False,area="Ayodhya Nagar"),

        # Chirayu Hospital Specific Pharmacies
        Pharmacy(name="Chirayu Medical Store", address="Chirayu Campus, Bairagarh", city="Bhopal", phone="9122334455", open_24hrs=True,area="Bairagarh"),
        Pharmacy(name="Bairagarh Medicos", address="Bhopal Byp, Bhainsakhedi, Bairagarh, Bhopal, Madhya Pradesh 462030", city="Bhopal", phone="9122334456", open_24hrs=False,area="Bairagarh"),
        Pharmacy(name="Sanjivani Pharmacy", address="Main Road, Bairagarh", city="Bhopal", phone="9122334457", open_24hrs=True,area="Bairagarh"),
        Pharmacy(name="Shubham Medical", address="Pushpa Nagar Chauraha, Maha Mai Rd, near bharat petrol pump, Ka Bagh, Aish Bagh, Bhopal, Madhya Pradesh 462010", city="Bhopal", phone="9111222347", open_24hrs=True,area="Bhopal"),
        Pharmacy(name="Krishna Pharmacy", address="Shop No 03, Krishna Complex, Ganpati Enclave, Near Bima Kunj Square, Colony Road, Kolar Road, Bhopal-462042, Madhya Pradesh", city="Bhopal", phone="9111222348", open_24hrs=False,area="Kolar Road"),
        Pharmacy(name="Vatsalya Medical Store", address="B-66, Chetak Bridge, Near Chetak Bridge, Chetak Bridge, Housing Board Colony, Kasturba Nagar, Bhopal, Madhya Pradesh 462011", city="Bhopal", phone="9111222349", open_24hrs=True,area="Bhopal"),
        Pharmacy(name="Aarogya Pharmacy", address="Ward No.-01, Sargo Tower, Deep Nagar Rd, near Pratham Dhaba, behind Bajrang WareHouse, Mahaveer Nagar, Mandideep, Bhopal, Madhya Pradesh 462046", city="Bhopal", phone="9111222350", open_24hrs=False,area="Bhopal"),
        Pharmacy(name="Kolar Health Store", address=" Ishika Tower, near Shiv Sweet, Mandakini Society, Shirdipuram, Kolar Rd, Gehun Kheda, Bhopal, Madhya Pradesh 462042", city="Bhopal", phone="9111222351", open_24hrs=True,area="Kolar Road"),
        Pharmacy(name="Awadhpuri Medical", address="7-A, near State Bank of India, A Sector, Awadhpuri, Bhopal, Madhya Pradesh 462022", city="Bhopal", phone="9111222352", open_24hrs=False,area="Bhopal"),
        Pharmacy(name="Saket Pharmacy", address="SaketagShop No:9, BDA Complex, Sector- 9/A Saket Nagar, Habib Ganj, Bhopal, Madhya Pradesh 462024ar", city="Bhopal", phone="9111222353", open_24hrs=True,area="Bhopal"),
